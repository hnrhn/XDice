...
public class ProofOfConceptConstants {
    public static final String configHelperBegin = "Hi! I'm the XDice configuration assistant!\n"
...
+"Ready when you are!";
    ...
    public static final String configHelperCountSuccesses = "Great! By default, XDice will roll d{0}s for you. On to the next step!\n\n"
...
+ "So, would you like XDice to count successes for you? _(Note: This will only apply to d{0}s. Other dice will just be rolled and displayed for you.)_\n\n";
    ...
    public static final String configHelperSuccessOn = "Excellent! Of course, to count Successes, XDice needs to know what your game considers a success to be, so let's configure that now.\n\n"
...
+ "This step is a little tricky for poor XDice, so make sure you include every number you want to consider as a success, with **one** space between them.";
    ...
    public static final String configHelperAddTotal = "Alrighty, no success-counting needed! But what about adding up the total of all of your dice in a roll? Is that something we can interest you in?\n\n"
...
+ "`/xdice config {0} yes` if you'd like that, or `/xdice config {0} no` if you want XDice to show you what you rolled and nothing more!";
    ...
    public static final String configHelperPlusBehaviour = "Our next configuration step is multiple-choice. XDice can handle inputs like **XdY + Z**. What we're going to set up now is what she should do with that **+ Z** part. Here are your options:\n\n"
...
+ "Up to you, boss!";
    ...
    public static final String configHelperExplodeBehaviour = "Our next step seems dangerous. \"Exploding Dice\"! In some systems, when you roll a certain number, the die can \"explode\" into copies of itself! XDice likes this one. She can handle that in _four_ different ways:"
...
+ "So what's it gonna be?";
    ...
    public static final String configHelperExplodeOn = "Got it! And now I just need to tell XDice which dice should explode for you."
...
+ "Off you go!";
    ...
    public static final String configHelperCritFail = "We're getting close to the end now, just one more configuration to set up!"
...
+ "One last time, tell me what you need!";
    ...
    public static final String configHelperConfirm = "\n"
+ "{1}"
+ "SPLIT"
...
+ "`/xdice config cancel` to discard all changes and exit configuration mode.";
    ...
    public static final String configHelperSignoff = "It's been a pleasure helping you configure my darling XDice. If you ever need me again... well... It's extremely unlikely that it will be _me_ specifically who gets assigned to your case, but one of my several billion siblings will be more than happy to help!"

+ "Happy rolling!"

+ "-- Confi";

    public static final String configHelperInputError = "Uh oh, that didn't work. Check your spelling and try again!";
}
