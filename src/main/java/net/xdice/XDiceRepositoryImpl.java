...
import net.xdice.fallenkingdoms.FKResult;
...
public class XDiceRepositoryImpl implements XDiceRepository {
    ...
    public FKResult getMostRecentRoll(String userId) throws SQLException {
    ...
    public void upsertMostRecentRoll(String userId, FKResult roll, boolean isPush) throws SQLException {
