...
import net.xdice.behaviour.forbiddenlands.FLResult;
...
public class XDiceRepositoryImpl implements XDiceRepository {
    ...
    public HashSet<String> getKnownGuilds() throws SQLException {
        ...
        while (results.next()) {
            ids.add(results.getString("GuildId"));
        }

        return ids;
    }

    public XDiceConfig getConfig(String guildId) throws SQLException {
        assert db != null;  // TODO: Handle this properly
        ...
        return new XDiceConfig(
            ...
            results.getInt("DefaultNumberOfDice"),
    ...
    private void upsertConfig(XDiceConfig config, String tableName) throws SQLException {
        ...
        upsertStatement.setString(1, config.getGuildId());
