...
public class ConfigInstructions {
    public static final String begin = """
            ...
            For example, if you are playing _Dungeons & Dragons_, you will be rolling a lot of d20s, so I can make that the default die.
    ...
    public static final String finalConfirmation = """
            ...
            or
            ~~`/xdice config cancel` to discard all changes and exit configuration mode.~~ The Creator appeared to me in a dream, riding an electric sheep, and told me he broke this, he promises to bring it back soon, but that for now you'll need to start over.
            """;
